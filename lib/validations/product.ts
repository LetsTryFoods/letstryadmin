...
export const variantFormSchema = z.object({
  ...
  stockQuantity: z.coerce.number().int("Stock must be a whole number").min(0, "Stock cannot be negative").default(0),
...
export const getDefaultVariant = (productName: string = ""): VariantFormValues => ({
  sku: "",
